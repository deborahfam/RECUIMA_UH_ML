...
formula='https://d14b9ctw0m6fid.cloudfront.net/ugblog/wp-content/uploads/2021/02/C3.png'

def main():
    
    st.title("RECUIMA")
    
    # Crea la sección de descripción general del dataset
    st.header("Aprendizaje Automático orientado a la detección de factores de riesgo para pacientes de infarto")
    ...
    st.subheader("I - Estado del arte")
    st.markdown("""
...
Redes neuronales convolucionales (CNN): Las CNN son una subcategoría de las redes neuronales que se utilizan comúnmente en el análisis de imágenes médicas. En el contexto de las enfermedades cardíacas, las CNN pueden ser utilizadas para analizar imágenes de electrocardiogramas (ECG) y ecocardiogramas para detectar signos de enfermedad cardíaca. """)
    st.markdown("##### I.1.2 - Máquinas de vectores de soporte (SVM)")
    st.markdown("""Las SVM son otra técnica comúnmente utilizada en la predicción de enfermedades cardíacas. Estos modelos son capaces de manejar datos de alta dimensión y pueden ser eficaces en la identificación de patrones complejos.""")
    st.markdown("##### I.1.3 - Árboles de decisión y bosques aleatorios")
    st.markdown("""Estos modelos son útiles para identificar las características más importantes en la predicción de enfermedades cardíacas. Los bosques aleatorios, en particular, son eficaces para manejar datos de alta dimensión y pueden proporcionar una medida de la importancia de las características.
""")
    st.markdown("##### I.1.4 - Deep learning")
    st.markdown("""El Deep Learning es una subcategoría del aprendizaje automático que utiliza redes neuronales con muchas capas (deep neural networks). Estos modelos son capaces de aprender características de alto nivel a partir de los datos y han demostrado ser eficaces en la predicción de enfermedades cardíacas.
""")
    st.markdown("### I.2 - Actualidad")
    st.markdown("""##### Estudio de García-Ordás et al. (2023)
...
Este estudio compara el rendimiento pronóstico de los sistemas de puntuación convencionales con un modelo de aprendizaje automático en la tomografía computarizada de coronarias para discriminar entre los pacientes con y sin eventos cardiovasculares adversos mayores.""")
    ...
    st.subheader("II - Introducción") 
    st.markdown("""#### II.1 - Objetivos del trabajo y descripción del problema
...
#### II.2.1 - Descripción de algunas características (features)
...
""")
    ...
    st.subheader("III - Desarrollo") 
    st.markdown("""Véase [[Original Dataset]] para tener todos los detalles necesarios acerca de los datos originales.
Dados los problemas anteriormente mencionados se modificó el conjunto de datos (_dataset_) para que fuera posible el uso de los mismos en el proyecto. Inicialmente se redujo la cantidad de características (_features_) a 18 con el objetivo de eliminar columnas muy dispersas y con información redundante. Véase [[Feature Reduction]].
Con esta reducción en los datos originales y con el completamiento de los datos faltantes se procedió a realizar la primera fase de predicción. En esta fase se usaron distintos algoritmos, que luego se repetirán en cada uno de los cambios al _dataset_, para comparar con las versiones anteriores y manteniendo una comparación entre los distintos algoritmos, para así optimizar tanto el modelo a emplear como los datos a utilizar. 

### III.1 - Algoritmos utilizados en el proyecto
...
#### III.1.2 - Support Vector Machine
...
#### III.1.4 - Multi Layer Perceptron
...
Si asumimos que las X siguen una distribución gaussiana o normal, debemos sustituir la densidad de probabilidad de la distribución normal y llamarla bayesiana ingenua gaussiana. Para calcular esta fórmula, necesita la media y la varianza de X.
    ...
    col1.image(formula, use_column_width=True)
    st.markdown("""
...
#### III.1.6 - Support Vector Classifier
...
#### III.1.8 - Sequential Neural Network
...
#### III.1.10 - Hist Gradient Boosting
...
Este estimador tiene soporte nativo para valores faltantes (NaN). Durante el entrenamiento, el cultivador de árboles aprende en cada punto de división si las muestras con valores faltantes deben ir al hijo izquierdo o derecho, según la ganancia potencial. Al predecir, las muestras con valores faltantes se asignan al hijo izquierdo o derecho en consecuencia. Si no se encontraron valores faltantes para una característica determinada durante el entrenamiento, las muestras con valores faltantes se asignan al hijo que tenga la mayor cantidad de muestras.
    """)
    st.subheader( "III.2 - ¿Por qué estos modelos?")
    st.markdown("""Por las características favorables a la solución del problema, por parte de cada uno de los algoritmos mencionados anteriormente y la popularidad de su uso que se puede apreciar en la siguiente tabla, se filtraron para ser utilizados en el [[Pipeline 1]] y ser sometidos a evaluación en nuestro problema.
...
#### III.3.4 - Nuevas Modificaciones a los dataset
...
#### III.3.5 - Segunda ronda de pruebas
...
#### III.3.6 - Tercera y Cuarta rondas de pruebas
...
#### III.3.7 - Completamiento de datos
